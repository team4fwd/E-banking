...
function UsersList() {
  ...
  const handleactivate = (id) => {
    activationAPI(id, token).then((data) => {
    ...
    { field: 'phone', headerName: 'Phone', width: 120 },
    {
      ...
      renderCell: (params) => {
        if (params.value === false) {
          return (
            <button
              className='usersList__acceptedBtn'
          ...
          return (
            <div className={'usersList__accepted nowrap'}>
              <p>
                <MdCheck /> activated
              </p>
            </div>
...

    {
      ...
      renderCell: (params) => {
        if (params.value === true) {
          return (
            <button
              className='usersList__rejectedBtn'
              onClick={() => handlesuspend(params.id)}
            >
              suspend
            </button>
          );
          ...
          return (
            <div className={'usersList__rejected nowrap'}>
              <p>
                <MdOutlineWarningAmber /> suspended
              </p>
            </div>
          );
        }
